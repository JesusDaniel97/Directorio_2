...
const estadosMunicipiosCobertura = {
    // Puedes agregar más estados y municipios según sea necesario
    AGUASCALIENTES:[
        "AGUASCALIENTES",
        "ASIENTOS",
        "CALVILLO",
...
ZACATECAS:[
  ...
  function cargarEstadosCobertura() {
    const estadoSelectorCobertura = document.getElementById("cobertura");
    const municipioSelectorCobertura = document.getElementById("municipios_cobertura");
  

    estadoSelectorCobertura.innerHTML = "<option value=''>-- Selecciona un estado --</option>";
    municipioSelectorCobertura.innerHTML = "<option value=''>-- Selecciona un municipio --</option>";
  
   
    const estadosCobertura = Object.keys(estadosMunicipiosCobertura);
  
   
    estadosCobertura.forEach((estado) => {
      const opcionEstado = document.createElement("option");
      opcionEstado.value = estado;
      opcionEstado.textContent = estado;
      estadoSelectorCobertura.appendChild(opcionEstado);
    });
  

    estadoSelectorCobertura.addEventListener("change", function () {
      const estadoSeleccionado = estadoSelectorCobertura.value;
  

      municipioSelectorCobertura.innerHTML = "<option value=''>-- Selecciona un municipio --</option>";
  
   
      if (estadoSeleccionado && estadosMunicipiosCobertura[estadoSeleccionado]) {
        const municipiosCobertura = estadosMunicipiosCobertura[estadoSeleccionado];
  

        municipiosCobertura.forEach((municipio) => {
          const opcionMunicipio = document.createElement("option");
          opcionMunicipio.value = municipio;
          opcionMunicipio.textContent = municipio;
          municipioSelectorCobertura.appendChild(opcionMunicipio);
        });
      }
    });
  }
  ...
  document.addEventListener("DOMContentLoaded", cargarEstadosCobertura);
